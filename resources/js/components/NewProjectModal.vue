    ...
    <modal name="new-project" classes="p-10 card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
            <div class="flex">
                <div class="flex-1 mr-4">
                    ...
                    <div class="mb-4">
                        ...
                        <span class="text-xs italic text-red-500" v-if="form.errors.description"
            ...
            <footer class="flex justify-end">
                <button type="button" class="button-outlined mr-4" @click="$modal.hide('new-project')">Cancel</button>
